...
variable "namespace_rules_list" {
  ...
  default     = ["AWS/Cassandra", "AWS/ApiGateway", "AWS/AppStream", "AWS/AppSync", "AWS/Athena", "AWS/Billing", "AWS/ACMPrivateCA", "AWS/Chatbot", "AWS/CloudFront" "AWS/CloudHSM", "AWS/CloudSearch", "AWS/Logs", "AWS/CodeBuild", "AWS/Cognito", "AWS/Connect", "AWS/DataSync", "AWS/DMS", "AWS/DX", "AWS/DocDB", "AWS/DynamoDB", "AWS/EC2", "AWS/EC2Spot", "AWS/AutoScaling", "AWS/ElasticBeanstalk", "AWS/EBS", "AWS/ECS", "AWS/EFS", "AWS/ElasticInference", "AWS/ApplicationELB", "AWS/ELB", "AWS/NetworkELB", "AWS/ElasticTranscoder", "AWS/ElastiCache", "AWS/ES", "AWS/ElasticMapReduce", "AWS/MediaConnect", "AWS/MediaConvert", "AWS/MediaPackage", "AWS/MediaTailor", "AWS/Events", "AWS/FSx", "AWS/GameLift", "AWS/Glue", "AWS/Inspector", "AWS/IoT", "AWS/IoTAnalytics", "AWS/ThingsGraph", "AWS/KMS", "AWS/KinesisAnalytics", "AWS/Firehose", "AWS/Kinesis", "AWS/KinesisVideo", "AWS/Lambda", "AWS/Lex", "AWS/ML", "AWS/Kafka", "AWS/AmazonMQ", "AWS/Neptune", "AWS/OpsWorks", "AWS/Polly", "AWS/QLDB", "AWS/Redshift", "AWS/RDS", "AWS/Robomaker", "AWS/Route53", "AWS/SageMaker", "AWS/SDKMetrics", "AWS/ServiceCatalog", "AWS/DDoSProtection", "AWS/SES", "AWS/SNS", "AWS/SQS", "AWS/S3", "AWS/SWF", "AWS/States", "AWS/StorageGateway", "AWS/SSM-RunCommand", "AWS/Textract", "AWS/Transfer", "AWS/Translate", "AWS/TrustedAdvisor", "AWS/NATGateway", "AWS/TransitGateway", "AWS/VPN", "WAF", "AWS/WorkMail", AWS/WorkSpaces"
}
